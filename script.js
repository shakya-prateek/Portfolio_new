...
╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚══════╝╚══════╝╚═╝  ╚═╝`;
    ...
    const welcome =
      ...
      this.wrapWithColor(
        "       AI/ML • GenAI • Data Science • Full-Stack Dev\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "CS & DS student at Newton School of Technology",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "with hands-on AI/ML, GenAI, and Full-Stack experience.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Building ML pipelines, agentic RAG systems, and",
  "#ffffff"
)}
${this.wrapWithColor("   production web apps with React, Next.js & Python", "#ff8c00")}
...
${this.wrapWithColor(
  "   through Applied GenAI and Data Science",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
  "   Strong problem-solver with expertise in end-to-end",
  "#ffffff"
)}
${this.wrapWithColor("   data-driven application development", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Ready to build intelligent applications together!",
      "#ffffff"
...
<span style="color: #00ffff;">HOUSE OF COUTON | Subject Matter Expert - AI/ML</span>
${this.wrapWithColor(
  "July 2026 - Present | Lucknow, Uttar Pradesh",
  "#ffffff"
)}

• ${this.wrapWithColor("AI/ML Initiatives", "#ffa07a")} - ${this.wrapWithColor(
      "Designing intelligent algorithms, modeling analytical pipelines, and translating machine learning models into business intelligence.",
      "#ffffff"
    )}

<span style="color: #00ffff;">INAMIGOS FOUNDATION | AI Data Analytics Intern</span>
${this.wrapWithColor(
  "June 2026 | Remote (India)",
  "#ffffff"
)}

• ${this.wrapWithColor("Data Processing", "#ffa07a")} - ${this.wrapWithColor(
      "Processed and analyzed complex data schemas, created statistical dashboards, and implemented modeling pipelines.",
      "#ffffff"
    )}

<span style="color: #00ffff;">NEWTON SCHOOL OF TECHNOLOGY | CS & Data Science</span>
${this.wrapWithColor(
  "2024 - 2028 | Sonepat, Haryana",
  "#ffffff"
)}

• ${this.wrapWithColor("AI/ML projects", "#ffa07a")} - ${this.wrapWithColor(
      "Built churn prediction, agentic RAG systems, and data pipelines.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Hackathons", "#ffa07a")} - ${this.wrapWithColor(
      "FoodScope @ IIIT Delhi, Changethon @ IIT Roorkee.",
      "#ffffff"
    )}

<span style="color: #00ffff;">AMDOX TECHNOLOGIES | Web Development Intern</span>
${this.wrapWithColor(
  "2025 | Remote (New Delhi)",
  "#ffffff"
)}

• ${this.wrapWithColor("Frontend dev", "#ffa07a")} - ${this.wrapWithColor(
      "Collaborated with the team to ship responsive React & TypeScript features. Integrated REST APIs, contributed to state refactoring, and built reusable UI component libraries.",
      "#ffffff"
    )}

<span style="color: #00ffff;">BLOOMING DALE SCHOOL | High School & Intermediate</span>
${this.wrapWithColor(
  "2020 - 2022 | Lucknow, Uttar Pradesh",
  "#ffffff"
)}`;
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Foundation of my AI/ML & full-stack journey    ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────╯",
...
<span style="color: #00ffff;">AI & GenAI:</span>
• ${this.wrapWithColor("LangChain, LangGraph, ChromaDB, Groq LLaMA, Semantic RAG", "#ffffff")}

<span style="color: #00ffff;">Data Science:</span>
• ${this.wrapWithColor("scikit-learn, Pandas, NumPy, Matplotlib, Seaborn, Tableau", "#ffffff")}

<span style="color: #00ffff;">Frontend:</span>
• ${this.wrapWithColor("React.js, Next.js, TypeScript, JavaScript, Tailwind CSS, Streamlit", "#ffffff")}

<span style="color: #00ffff;">Backend:</span>
• ${this.wrapWithColor("Node.js, Express.js, FastAPI, Socket.IO, NextAuth.js", "#ffffff")}

<span style="color: #00ffff;">Databases:</span>
• ${this.wrapWithColor("PostgreSQL, MongoDB, Supabase, Firebase, Prisma ORM", "#ffffff")}

<span style="color: #00ffff;">Tools:</span>
• ${this.wrapWithColor("Git, GitHub, Docker, Vercel, Streamlit Cloud, Jupyter, Figma", "#ffffff")}

<span style="color: #00ffff;">Languages:</span>
• ${this.wrapWithColor("Python, SQL, JavaScript, TypeScript, Java, HTML/CSS", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:prateek.shakya2024@nst.rishihood.edu.in" style="color: #ffffff; text-decoration: none;">prateek.shakya2024@nst.rishihood.edu.in</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://shakya-prateek.github.io" target="_blank" style="color: #ffffff; text-decoration: none;">shakya-prateek.github.io</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/shakya-prateek" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/shakya-prateek</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/prateek-shakya-756273316/" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/prateek-shakya-756273316</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
  ...
  setupFileSystem() {
    this.fileSystem = {
      resume: {
        type: "directory",
        contents: {
          "about.txt": { type: "file", content: "AI/ML, GenAI, and Full-Stack Developer based in Lucknow, India." },
          "skills.md": { type: "file", content: "# Tech Skills\n- Python, TypeScript, SQL\n- LangChain, LangGraph, ChromaDB\n- React, Next.js, FastAPI, Node.js" },
          experience: {
            type: "directory",
            contents: {
              "houseofcouton.txt": { type: "file", content: "House of Couton: Subject Matter Expert - AI/ML (July 2026 - Present)" },
              "inamigos.txt": { type: "file", content: "InAmigos Foundation: AI Data Analytics Intern (June 2026)" },
              "amdox.txt": { type: "file", content: "Amdox Technologies: Web Development Intern (2025)" }
            }
          },
          projects: {
            type: "directory",
            contents: {
              "churnagent.md": { type: "file", content: "ChurnAgent: AI customer churn prediction & RAG decision system." },
              "eventsphere.md": { type: "file", content: "EventSphere: Production event management and ticketing platform." },
              "sync.md": { type: "file", content: "Sync: Real-time chat application using Socket.IO." }
            },
          },
        },
      },
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "prateek@shakya: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    url.textContent = "shakya-prateek.github.io";
